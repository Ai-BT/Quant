"""
SMA 20/50 골든크로스 전략 백테스팅 실행

설정 파일(config/sma20_50_config.py)의 값을 변경하여 전략을 조정할 수 있습니다.
특히 MARKET 변수를 변경하여 다른 코인으로 테스트할 수 있습니다.
...
# 설정 파일 import
import config.sma20_50_config as cfg
...
def main():
    """메인 함수"""
    print("=" * 70)
    print("🚀 SMA 20/50 골든크로스 전략 백테스팅")
    print("=" * 70)
    print()
    
    # 설정 출력
    print("📋 전략 설정:")
    print(f"   - 전략: 단순 골든크로스 (RSI 필터 없음)")
    ...
    print("   예: MARKET = 'KRW-ETH' (이더리움), 'KRW-XRP' (리플), 'KRW-SOL' (솔라나)")
